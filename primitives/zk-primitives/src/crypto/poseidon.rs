...
//!
//! This implementation uses `poseidon-ark` which is **compatible with circomlib/iden3**,
...
//!
//! ```rust,ignore
//! use fp_zk_primitives::crypto::poseidon::*;
//! use ark_bn254::Fr;
//!
...
//! - poseidon-ark: https://github.com/arnaucube/poseidon-ark

use crate::Bn254Fr;
// use sp_std::{vec, vec::Vec}; // Removed here, used only in tests
