...
//! Generated on: 2026-03-06 11:30:35 -03
...
pub fn get_vk() -> VerifyingKey<Bn254> {
	...
	let delta_g2 = G2Affine::new_unchecked(
		Fq2::new(
			Fq::from_str(
				"21288944529661557469672422705557159068094267422651824241917478140990622096224",
			)
			.unwrap(),
			Fq::from_str(
				"21189770105809850421822299960373888134179868258348867092557256045711186362185",
			)
			.unwrap(),
		),
		Fq2::new(
			Fq::from_str(
				"21381531167402160909176932968047439104775642314508271622621584209404202122222",
			)
			.unwrap(),
			Fq::from_str(
				"8807364154706141681018827860148590990916867586874031919777663563213093978165",
			)
			.unwrap(),
		),
	);
