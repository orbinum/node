...
//! Generated on: 2026-03-06 11:30:34 -03
...
pub fn get_vk() -> VerifyingKey<Bn254> {
	...
	let delta_g2 = G2Affine::new_unchecked(
		Fq2::new(
			Fq::from_str(
				"3206276217260361595481793508853284750402422152671604776989575287423476104269",
			)
			.unwrap(),
			Fq::from_str(
				"7631747384853902460664967521543155868991166764222053253093017957540938334392",
			)
			.unwrap(),
		),
		Fq2::new(
			Fq::from_str(
				"1315736626707762138289399134507660238847527772864111688734249969354839349763",
			)
			.unwrap(),
			Fq::from_str(
				"13007248231956190625731466221524250435067067612777017226899945000235029993336",
			)
			.unwrap(),
		),
	);
