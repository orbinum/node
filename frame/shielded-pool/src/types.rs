...
pub enum DisclosureCondition<Balance, BlockNumber> {
	Always,
	TimeDelay { after_block: BlockNumber },
	AmountThreshold { min_amount: Balance },
}
...
/// A selective disclosure record stored on-chain.
#[derive(
	Clone,
	PartialEq,
	Eq,
...
pub struct DisclosureRecord<AccountId, BlockNumber> {
