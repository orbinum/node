...
pub fn development() -> serde_json::Value {
	testnet_genesis(
		...
		vec![
			...
			(ethereum_to_account_id(hex!("f24FF3a9CF04c71Dbc94D0b566f7A27B94566cac")), TOTAL_SUPPLY), // Alith
			...
			(ethereum_to_account_id(hex!("3Cd0A705a2DC65e5b1E1205896BaA2be8A07c6e0")), DEV_BALANCE), // Baltathar
			(ethereum_to_account_id(hex!("798d4Ba9baf0064Ec19eB4F0a1a45785ae9D6DFc")), DEV_BALANCE), // Charleth
			(ethereum_to_account_id(hex!("773539d4Ac0e786233D90A233654ccEE26a613D9")), DEV_BALANCE), // Dorothy
			(ethereum_to_account_id(hex!("Ff64d3F6efE2317EE2807d223a0Bdc4c0c49dfDB")), DEV_BALANCE), // Ethan
			(ethereum_to_account_id(hex!("C0F0f4ab324C46e55D02D0033343B4Be8A55532d")), DEV_BALANCE), // Faith
			// CI test runner
			(ethereum_to_account_id(hex!("6be02d1d3665660d22ff9624b7be0551ee1ac91b")), DEV_BALANCE),
		],
		vec![],
		42,    // chain id
